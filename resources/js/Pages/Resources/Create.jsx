...
export default function Create({ subjects }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Create Resource</h2>}>
                ...
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <form onSubmit={submit}>
                            ...
                            <div className="mb-4">
                                <InputLabel htmlFor="attachment" value="Attachment (File)" />
                                <input
                                    type="file"
                                    id="attachment"
                                    className="mt-1 block w-full"
